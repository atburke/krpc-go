...
func NewUI(client *krpcgo.KRPCClient) *UI {
...
//
// Allowed game scenes: any.
func (s *UI) StreamAddCanvas() (*krpcgo.Stream[Canvas], error) {
	var err error
	request := &api.ProcedureCall{
		Procedure: "AddCanvas",
		Service:   "UI",
	...
	stream := krpcgo.MapStream(rawStream, func(b []byte) Canvas {
		var value Canvas
...
//
// Allowed game scenes: any.
func (s *UI) StreamStockCanvas() (*krpcgo.Stream[Canvas], error) {
	var err error
	request := &api.ProcedureCall{
		Procedure: "get_StockCanvas",
		Service:   "UI",
...
//
// Allowed game scenes: any.
func (s *Button) StreamRectTransform() (*krpcgo.Stream[RectTransform], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Button_get_RectTransform",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := krpcgo.MapStream(rawStream, func(b []byte) RectTransform {
...
//
// Allowed game scenes: any.
func (s *Button) StreamText() (*krpcgo.Stream[Text], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Button_get_Text",
...
//
// Allowed game scenes: any.
func (s *Canvas) StreamAddPanel(visible bool) (*krpcgo.Stream[Panel], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Canvas_AddPanel",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := krpcgo.MapStream(rawStream, func(b []byte) Panel {
		var value Panel
		encode.Unmarshal(b, &value)
		return value
	})
...
//
// Allowed game scenes: any.
func (s *Canvas) StreamAddText(content string, visible bool) (*krpcgo.Stream[Text], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Canvas_AddText",
...
//
// Allowed game scenes: any.
func (s *Canvas) StreamAddInputField(visible bool) (*krpcgo.Stream[InputField], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Canvas_AddInputField",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := krpcgo.MapStream(rawStream, func(b []byte) InputField {
...
//
// Allowed game scenes: any.
func (s *Canvas) StreamAddButton(content string, visible bool) (*krpcgo.Stream[Button], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Canvas_AddButton",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := krpcgo.MapStream(rawStream, func(b []byte) Button {
		var value Button
		encode.Unmarshal(b, &value)
		return value
	})
...
//
// Allowed game scenes: any.
func (s *Canvas) StreamRectTransform() (*krpcgo.Stream[RectTransform], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Canvas_get_RectTransform",
...
//
// Allowed game scenes: any.
func (s *InputField) StreamRectTransform() (*krpcgo.Stream[RectTransform], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "InputField_get_RectTransform",
...
//
// Allowed game scenes: any.
func (s *InputField) StreamText() (*krpcgo.Stream[Text], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "InputField_get_Text",
...
//
// Allowed game scenes: any.
func (s *Panel) StreamAddPanel(visible bool) (*krpcgo.Stream[Panel], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Panel_AddPanel",
...
//
// Allowed game scenes: any.
func (s *Panel) StreamAddText(content string, visible bool) (*krpcgo.Stream[Text], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Panel_AddText",
...
//
// Allowed game scenes: any.
func (s *Panel) StreamAddInputField(visible bool) (*krpcgo.Stream[InputField], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Panel_AddInputField",
...
//
// Allowed game scenes: any.
func (s *Panel) StreamAddButton(content string, visible bool) (*krpcgo.Stream[Button], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Panel_AddButton",
...
//
// Allowed game scenes: any.
func (s *Panel) StreamRectTransform() (*krpcgo.Stream[RectTransform], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Panel_get_RectTransform",
...
//
// Allowed game scenes: any.
func (s *Text) StreamRectTransform() (*krpcgo.Stream[RectTransform], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_RectTransform",
