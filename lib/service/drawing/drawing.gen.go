...
import (
	...
	ui "github.com/atburke/krpc-go/lib/service/ui"
...
func NewLine(id uint64, client *client.KRPCClient) *Line {
...
func NewPolygon(id uint64, client *client.KRPCClient) *Polygon {
...
func NewDrawing(client *client.KRPCClient) *Drawing {
...
//
// Allowed game scenes: any.
func (s *Drawing) StreamAddLine(start api.Tuple3[float64, float64, float64], end api.Tuple3[float64, float64, float64], referenceFrame spacecenter.ReferenceFrame, visible bool) (*client.Stream[Line], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "AddLine",
	...
	stream := client.MapStream(rawStream, func(b []byte) Line {
		var value Line
...
//
// Allowed game scenes: any.
func (s *Drawing) StreamAddDirection(direction api.Tuple3[float64, float64, float64], referenceFrame spacecenter.ReferenceFrame, length float32, visible bool) (*client.Stream[Line], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "AddDirection",
...
//
// Allowed game scenes: any.
func (s *Drawing) StreamAddDirectionFromCom(direction api.Tuple3[float64, float64, float64], referenceFrame spacecenter.ReferenceFrame, length float32, visible bool) (*client.Stream[Line], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "AddDirectionFromCom",
...
//
// Allowed game scenes: any.
func (s *Drawing) StreamAddPolygon(vertices []api.Tuple3[float64, float64, float64], referenceFrame spacecenter.ReferenceFrame, visible bool) (*client.Stream[Polygon], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "AddPolygon",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := client.MapStream(rawStream, func(b []byte) Polygon {
		var value Polygon
		encode.Unmarshal(b, &value)
		return value
	})
...
//
// Allowed game scenes: any.
func (s *Drawing) StreamAddText(text string, referenceFrame spacecenter.ReferenceFrame, position api.Tuple3[float64, float64, float64], rotation api.Tuple4[float64, float64, float64, float64], visible bool) (*client.Stream[Text], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "AddText",
...
//
// Allowed game scenes: any.
func (s *Line) StreamStart() (*client.Stream[api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_Start",
...
//
// Allowed game scenes: any.
func (s *Line) StreamEnd() (*client.Stream[api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_End",
...
//
// Allowed game scenes: any.
func (s *Line) StreamColor() (*client.Stream[api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_Color",
...
//
// Allowed game scenes: any.
func (s *Line) StreamThickness() (*client.Stream[float32], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_Thickness",
...
//
// Allowed game scenes: any.
func (s *Line) StreamReferenceFrame() (*client.Stream[spacecenter.ReferenceFrame], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_ReferenceFrame",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := client.MapStream(rawStream, func(b []byte) spacecenter.ReferenceFrame {
...
//
// Allowed game scenes: any.
func (s *Line) StreamVisible() (*client.Stream[bool], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_Visible",
...
//
// Allowed game scenes: any.
func (s *Line) StreamMaterial() (*client.Stream[string], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Line_get_Material",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamVertices() (*client.Stream[[]api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_Vertices",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamColor() (*client.Stream[api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_Color",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamThickness() (*client.Stream[float32], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_Thickness",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamReferenceFrame() (*client.Stream[spacecenter.ReferenceFrame], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_ReferenceFrame",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamVisible() (*client.Stream[bool], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_Visible",
...
//
// Allowed game scenes: any.
func (s *Polygon) StreamMaterial() (*client.Stream[string], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Polygon_get_Material",
...
//
// Allowed game scenes: any.
func (s *Text) StreamPosition() (*client.Stream[api.Tuple3[float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Position",
...
//
// Allowed game scenes: any.
func (s *Text) StreamRotation() (*client.Stream[api.Tuple4[float64, float64, float64, float64]], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Rotation",
...
//
// Allowed game scenes: any.
func (s *Text) StreamCharacterSize() (*client.Stream[float32], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_CharacterSize",
...
//
// Allowed game scenes: any.
func (s *Text) StreamStyle() (*client.Stream[ui.FontStyle], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Style",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := client.MapStream(rawStream, func(b []byte) ui.FontStyle {
...
//
// Allowed game scenes: any.
func (s *Text) StreamAlignment() (*client.Stream[ui.TextAlignment], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Alignment",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := client.MapStream(rawStream, func(b []byte) ui.TextAlignment {
...
//
// Allowed game scenes: any.
func (s *Text) StreamAnchor() (*client.Stream[ui.TextAnchor], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Anchor",
	...
	rawStream := s.Client.GetStream(st.Id)
	stream := client.MapStream(rawStream, func(b []byte) ui.TextAnchor {
...
//
// Allowed game scenes: any.
func (s *Text) StreamReferenceFrame() (*client.Stream[spacecenter.ReferenceFrame], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_ReferenceFrame",
...
//
// Allowed game scenes: any.
func (s *Text) StreamMaterial() (*client.Stream[string], error) {
	var err error
	var argBytes []byte
	request := &api.ProcedureCall{
		Procedure: "Text_get_Material",
